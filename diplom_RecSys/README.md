...
| Модель | RMSE | MAE | Особенности |
|--------|------|-----|-------------|
| SVD (Surprise) | **0.9519** | 0.7510 | Лучшая одиночная модель |
| Implicit ALS | 3.5127 | 3.2531 | Для implicit feedback |
| GridSearchCV | 0.9519 | 0.7521 | С подбором гиперпараметров |
| Ансамбль | 1.9413 | 1.7189 | Voting-подход |
| CatBoost | 1.0648 | 0.8541 | Градиентный бустинг |
